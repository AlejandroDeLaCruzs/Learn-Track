            ...
            if (email.equals(usuario.getCorreo())) {
                ...
                if (contraseniaIngresada.equals(usuario.getContrasenia())) {
                    ...
                    if (usuario instanceof Administrador) {
                        usuarioactivo = new Administrador(usuario.getIdusuario(), usuario.getNombre(), usuario.getCorreo(),usuario.getContrasenia());
                    } else if (usuario instanceof Alumno) {
                        usuarioactivo = new Alumno(usuario.getIdusuario(), usuario.getNombre(), usuario.getCorreo(), usuario.getContrasenia());
                    } else {
                        usuarioactivo = new Profesor(usuario.getIdusuario(), usuario.getNombre(), usuario.getCorreo(),usuario.getContrasenia());
                    }
